...
\begin{center}
  \alert<7>{Nicht} \pause zu \pause viele \pause \textbf{\Large Effekte} \pause verwenden\pause!
\end{center}
\end{frame}
...
\begin{frame}{Lemma}
\begin{lemma}[über Etwas]
  Lemma
\end{lemma}
\end{frame}

\begin{frame}{Theorem}
\begin{theorem}[über Etwas]
  Theorem
\end{theorem}
\end{frame}
...
\begin{frame}
\begin{center}
\Huge \textbf{Viel Spaß und Erfolg!}
\end{center}
\end{frame}
